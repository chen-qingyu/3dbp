...
TEST_CASE("Constraint")
{
    ...
    std::vector<Box> boxes = {{"origin", 5, 5, 5, 10.0, 0, 0, 0}};
    Box box_x{"bx", 5, 5, 5, 10.0, 5, 0, 0};
    Box box_y{"by", 5, 5, 5, 10.0, 0, 5, 0};
    Box box_z{"bz", 5, 5, 5, 10.0, 0, 0, 5};

    SECTION("check_bound")
    {
        Constraint constraint(container, boxes);

        Box box_bad{"bad", 5, 5, 6, 10.0, 0, 0, 5}; // Exceeds container height
    ...
    SECTION("check_overlap")
    {
        ...
        Box box_bad{"bad", 5, 5, 5, 10.0, 0, 0, 4}; // Overlaps with origin box
    ...
    SECTION("check_support")
    {
        ...
        Box box_bad{"bad", 5, 5, 5, 10.0, 5, 0, 1}; // Not properly supported
    ...
    SECTION("check_weight")
    {
        ...
        Box box_bad{"bad", 5, 5, 5, 100.0, 5, 0, 0}; // Exceeds weight limit
